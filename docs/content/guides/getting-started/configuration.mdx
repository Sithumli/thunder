...
The system resource server controls administrative permissions for Thunder Console operations such as managing users, groups, organization units, and user types. You can customize the handle and identifier to fit your deployment requirements.
